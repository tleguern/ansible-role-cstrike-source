...
Either send [send GitHub pull requests](https://github.com/Aversiste/ansible-role-cstrike-source) or [send patches on SourceHut](https://lists.sr.ht/~tleguern/misc).
